...
<html lang="en-US">
  <head>
    ...
    <title>My JSP 'new_company.jsp' starting page</title>
  ...
  <div class="navbar navbar-inverse" style="position: static;">
	...
	<div class="container1">
				...
				<tbody>
					<div class="right-top"> 
						...
						<div class="right-top-span">
							<span class="right-top-span-left">Add a new company or <a href="<%=basePath %>contact/newcontact.action" style="text-decoration:underline;color:blue;font-size:12px;">add a new person</a></span>
							<br/>
							<tr>
								<th ><h6>公司名称：</h6></th>
								<input type="text"  >
					...
					<div class="right-bottom" style="padding-left:30px">
					<tr>
		...
		<div class="lastright">
			...
			<div class="middletext"><a href="new_contact.html" style="text-decoration:underline;color:#2a47cb">Add a new task</a></div>
		</div>
