				...
				<tbody>
					<div class="right-top"> 
						...
						<div class="right-top-span">
							<span class="right-top-span-left">Add a new person or <a href="<%=basePath %>/contact/newcompany.action" style="text-decoration:underline;color:blue;font-size:12px;">add a new company</a></span>
							<br/>
							<tr>
								<th ><h6>姓名：</h6></th>
								<input type="text"  >
					...
					<div class="right-bottom" style="padding-left:30px">
						...
						<tr>
							<th ><h6>背景信息：</h6></th>
							<textarea name="" id="" cols="30" rows="10">例如：是如何见面的，等等</textarea>
